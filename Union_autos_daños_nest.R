...
Primas_autos_danos_nest<-bind_rows(autos,danos)

Primas_autos_danos_nest<-Primas_autos_danos_nest%>%
  filter(is.na(Periodo)==FALSE)

Encoding(Primas_autos_danos_nest$Ramo)<-"UTF-8"
#Encoding(Primas_autos_danos_nest$Oficina)<-"UTF-8"
Encoding(Primas_autos_danos_nest$Nombre)<-"UTF-8"
#Encoding(Primas_autos_danos_nest$NombreAsegurado)<-"UTF-8"
#Encoding(Primas_autos_danos_nest$DescTipoVehiculo)<-"UTF-8"
Encoding(Primas_autos_danos_nest$DescGrupoTipoPoliza)<-"UTF-8"
#Encoding(Primas_autos_danos_nest$NombreAsegurado)<-"UTF-8"
Encoding(Primas_autos_danos_nest$Tipo_vehículoII)<-"UTF-8"
#Encoding(Primas_autos_danos_nest$Canal_Comercial)<-"UTF-8"
#Encoding(Primas_autos_danos_nest$Promotoria)<-"UTF-8"
Encoding(Primas_autos_danos_nest$CanalVenta)<-"UTF-8"
