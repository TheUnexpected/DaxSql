...
FROM (
	...
	and ctz.TiempoCotizacion >= '20250101' 
	and  ctz.TiempoCotizacion <= '20251231' 
	and ctz.Eliminado = 0  
	--and  emi.nipperfilagente in (SELECT nipperfilagente FROM tb_bi_dimagente where nombreagente = 'HDI SEGUROS SA DE CV')
	...
	--and isnull( axc.NipPerfilAgente, emi.NipPerfilAgente) in (69982, 55783 ,58997 ,61795 ,65627 ,66081 ,67197 ,90712 ,90713 ,90750 ,90751 ,90752, 58577 )  
	--and isnull( axc.NipPerfilAgente, emi.NipPerfilAgente) in (110494) 
	...
	--and ctz.NumCompletoCotizacion = 110494
