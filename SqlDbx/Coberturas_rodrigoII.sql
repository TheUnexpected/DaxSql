SELECT 
		...
		CASE WHEN cob.DescCobertura IN ('PÉRDIDA TOTAL PREFERENCIAL','PÉRDIDA TOTAL PREFERENCIAL PRIME') THEN 'PÉRDIDA TOTAL PREFERENCIAL'
			WHEN cob.DescCobertura IN ('REPARACION EN AGENCIA','REPARACIÓN EN AGENCIA','REPARACION EN AGENCIA PRIME') THEN 'REPARACION EN AGENCIA'
			WHEN cob.DescCobertura IN ('SEGURO DE LLANTAS Y RINES','SEGURO DE LLANTAS Y RINES_GAMA') THEN 'SEGURO DE LLANTAS Y RINES'
			ELSE cob.DescCobertura end AS Cobertura,
