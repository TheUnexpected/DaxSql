...
SELECT
	...
	, CKCalculado = RIGHT('00000' + ltrim(rtrim(e.IdOficina)),5) + '-'+ RIGHT('0000000000' + ltrim(rtrim(e.NumPoliza)),10) + '-' + CAST(e.NumCertificado AS VARCHAR)
...
WHERE e.FechaTransaccion >= 20210401
--AND ofi.DescDireccionComercial IN ('Norte', 'Bajío - Occidente', 'México - Sur')
--and e.IdClasificacionProducto = 15 and e.IdSubclasificacionProducto = 2   -- HDI iDriving
AND e.IdPaquete IN (2458, 2459, 2529, 2530, 2607, 2608, 2609, 2610) -- PRODUCTOS IDRIVING
